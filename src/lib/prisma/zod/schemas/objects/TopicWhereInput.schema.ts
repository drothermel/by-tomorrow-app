...
const Schema: z.ZodType<Prisma.TopicWhereInput> = z
	.object({
		AND: z
			.union([
				z.lazy(() => TopicWhereInputObjectSchema),
				z.lazy(() => TopicWhereInputObjectSchema).array(),
			])
			.optional(),
		OR: z
			.lazy(() => TopicWhereInputObjectSchema)
			.array()
			.optional(),
		NOT: z
			.union([
...
export const TopicWhereInputObjectSchema = Schema
