...
const Schema: z.ZodType<Prisma.TopicCountAggregateInputType> = z
	.object({
		id: z.literal(true).optional(),
		topic: z.literal(true).optional(),
		topicHistory: z.literal(true).optional(),
...
export const TopicCountAggregateInputObjectSchema = Schema
