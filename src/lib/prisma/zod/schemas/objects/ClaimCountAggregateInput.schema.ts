...
const Schema: z.ZodType<Prisma.ClaimCountAggregateInputType> = z
	.object({
		id: z.literal(true).optional(),
		claim: z.literal(true).optional(),
		claimHistory: z.literal(true).optional(),
...
export const ClaimCountAggregateInputObjectSchema = Schema
