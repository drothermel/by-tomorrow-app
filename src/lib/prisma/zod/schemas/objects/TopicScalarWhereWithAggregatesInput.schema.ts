...
const Schema: z.ZodType<Prisma.TopicScalarWhereWithAggregatesInput> = z
	.object({
		AND: z
			.union([
				z.lazy(() => TopicScalarWhereWithAggregatesInputObjectSchema),
				z.lazy(() => TopicScalarWhereWithAggregatesInputObjectSchema).array(),
			])
			.optional(),
		OR: z
			.lazy(() => TopicScalarWhereWithAggregatesInputObjectSchema)
			.array()
			.optional(),
		NOT: z
			.union([
		...
		topic: z
			...
			.optional(),
		topicHistory: z.lazy(() => StringNullableListFilterObjectSchema).optional(),
		tags: z
			.union([
...
export const TopicScalarWhereWithAggregatesInputObjectSchema = Schema
